...
var TestController = /*#__PURE__*/function () {
  ...
  return _createClass(TestController, [{
    key: "index",
    value: function () {
      ...
      var _create = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return TestService.create(req.body);
            case 2:
      ...
      var _show = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return TestService.findById(parseInt(req.params.test_id || ""));
            case 2:
              test = _context3.sent;
    ...
    key: "updatePassword",
    value: function () {
      var _updatePassword = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return TestService.updatePassword(parseInt(req.params.test_id), req.body.oldPassword, req.body.newPassword);
            case 2:
      ...
      var _update = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              obj = JSON.parse(JSON.stringify(_objectSpread({}, req.files)));
              ...
              _context5.next = 5;
              return TestService.update(parseInt(req.params.test_id), data);
            case 5:
      ...
      var _delete2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _context6.next = 2;
              return TestService["delete"](parseInt(req.params.test_id || ""));
            case 2:
